...
|Telegram|2|<li>权限提示-通知权限<li>其他-添加生日提示|
|Telegram|1|<li>更新提示|
...
|youtube|7|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>权限提示-通知权限<li>功能类-自动翻译评论<li>其他-关闭播放器辅助功能弹窗<li>功能类-关闭视频播放结束后的推荐视频|
...
|123云盘|4|<li>全屏广告-弹窗广告<li>更新提示<li>功能类-扫码自动确认登录<li>全屏广告-相册自动备份弹窗|
...
|爱吾游戏宝盒|1|<li>青少年模式|
|安吉星|1|<li>开屏广告|
|安全服务/小米手机管家|9|<li>功能类-USB安装应用,自动点击[继续安装]<li>功能类-禁止获取定位<li>功能类-使用返回退出时直接点击[退出]<li>功能类-电量已低于20%<li>功能类-高敏感权限自动确定<li>功能类-应用信息页-自启动提示<li>功能类-自动允许分享文件<li>功能类-自动关闭SIM卡安全保护验证提示<li>功能类-禁止后台运行弹窗|
...
|滴滴车主|1|<li>全屏广告-弹窗广告|
|滴滴出行|4|<li>局部广告-打车页面右上角红包广告<li>更新提示<li>全屏广告-弹窗广告<li>全屏广告-[升级一键付款]弹窗|
|点心云|1|<li>开屏广告|
...
|抖音|21|<li>开屏广告<li>局部广告-关闭用户推荐<li>更新提示-关闭更新弹窗<li>功能类-设置无声进入抖音弹窗<li>权限提示-通知权限<li>功能类-自动勾选原图<li>其他-休息提醒<li>功能类-[添加快捷方式到桌面]弹窗<li>全屏广告-视频播放中途插入的打招呼界面<li>全屏广告-关闭商城推荐<li>局部广告-拍同款弹窗<li>全屏广告-[去首页商城]弹窗<li>全屏广告-低价秒杀券弹窗<li>权限提示-请求访问通讯录弹窗<li>青少年模式<li>权限提示-定位权限<li>全屏广告-汽水音乐VIP<li>其他-个性化推荐弹窗<li>全屏广告-视频推荐广告<li>局部广告-游戏直播间浮标广告<li>功能类-自动领取别人发的红包|
...
|起点读书|11|<li>开屏广告<li>更新提示<li>青少年模式<li>全屏广告-活动弹窗<li>权限提示-通知权限<li>局部广告-悬浮广告<li>功能类-起点中文网登录自动确认<li>局部广告-信息流广告<li>其他-福利中心看视频后获得奖励<li>全屏广告-红包弹窗<li>功能类-移动网络下自动点击播放视频|
|汽车之家|2|<li>全屏广告-弹窗广告<li>局部广告-右下角领福利悬浮窗|
|汽水音乐|9|<li>开屏广告<li>更新提示<li>全屏广告-VIP弹窗<li>功能类-看广告视频拿VIP<li>功能类-看广告获取听歌时长<li>功能类-看视频免费听弹窗<li>评价提示-评分弹窗<li>局部广告-悬浮窗广告<li>其他-关闭[更多直播]推荐|
...
|淘宝|16|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-消息页面热门活动卡片<li>局部广告-悬浮广告<li>权限提示-通知权限<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限提示-悬浮窗权限<li>全屏广告-花呗推荐弹窗<li>全屏广告-抢天降补贴弹窗<li>局部广告-商品详情页直播悬浮窗<li>功能类-登录授权<li>全屏广告-支付后的推荐弹窗<li>局部广告-搜索页广告|
...
|天气|1|<li>分段广告-卡片广告|
|天气|2|<li>局部广告-底部卡片广告<li>分段广告-卡片广告|
...
|稀饭动漫|1|<li>全屏广告-弹窗广告|
|稀土掘金|1|<li>更新提示|
|喜马拉雅|12|<li>局部广告-首页右侧浮动广告<li>局部广告-播放页广告<li>分段广告-播放页面-底部推荐列表-夹杂广告<li>局部广告-播放页面-播放前广告<li>分段广告-信息流广告<li>局部广告-热播推荐广告<li>青少年模式<li>局部广告-评论区广告<li>全屏广告-首页-专辑订阅推荐弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>全屏广告-免流提示|
...
|小米商城|3|<li>全屏广告-弹窗广告<li>局部广告-悬浮广告<li>更新提示|
|小米社区|4|<li>更新提示<li>局部广告-评论区卡片广告<li>全屏广告-签到弹窗<li>全屏广告-公告板弹窗|
|小米视频|1|<li>分段广告-卡片广告|
|小米相册|2|<li>功能类-删除时勾选[同时从云端删除]<li>功能类-流量同步自动点击[继续同步]|
|小米音乐|7|<li>局部广告-悬浮广告<li>局部广告-横幅广告<li>全屏广告-弹窗广告<li>其他-年度报告邀请函弹窗<li>功能类-看广告视频领VIP<li>局部广告-主界面卡片广告<li>分段广告-首页卡片广告|
...
|学习通|3|<li>功能类-提示没有网络时点击[重试/确定]<li>功能类-提示非WIFI环境时点击[继续]，使用流量播放<li>权限提示-通知权限|
|学小易|2|<li>分段广告-首页-底部广告<li>更新提示|
|雪球|3|<li>局部广告-信息流广告<li>局部广告-评论区广告<li>全屏广告|
|雪球基金|1|<li>全屏广告-基金页面弹窗广告|
|迅雷|9|<li>开屏广告<li>分段广告-视频详情页广告<li>分段广告-视频详情页直播推荐<li>全屏广告-弹窗广告<li>分段广告-"下载页"卡片广告<li>更新提示<li>全屏广告-会员广告<li>局部广告-卡片广告<li>权限提示-通知权限|
...
|中国工商银行|3|<li>全屏广告-弹窗广告<li>评价提示<li>局部广告-右下角浮标广告|
|中国广电|1|<li>更新提示|
...
|PU口袋校园|2|<li>全屏广告-弹窗广告<li>局部广告-首页-右侧浮窗广告|
|QQ浏览器|3|<li>开屏广告<li>分段广告-小说阅读页面-卡片广告<li>分段广告-小说阅读页面-视频广告|
|QQ音乐|10|<li>开屏广告<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>更新提示-内测体验弹窗<li>全屏广告-免流弹窗<li>全屏广告-看广告免费听歌弹窗<li>全屏广告-VIP弹窗<li>评价提示-好评弹窗<li>分段广告-评论区广告<li>其他-播放页[猜你也会喜欢]推荐|
